...
- Modified `int_quickbooks__retained_earnings` intermediate model to more accurately reflect retained earnings accounts as "Net Income Adjustment". [#57](https://github.com/fivetran/dbt_quickbooks/issues/57)
