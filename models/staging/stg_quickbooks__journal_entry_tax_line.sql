...
with base as (
    ...
    select * 
    from {{ ref('stg_quickbooks__journal_entry_tax_line_tmp') }}
),
        ...
        */
        ...
        {{
            fivetran_utils.fill_staging_columns(
                source_columns=adapter.get_columns_in_relation(ref('stg_quickbooks__journal_entry_tax_line_tmp')),
                staging_columns=get_journal_entry_tax_line_columns()
            )
        }}
