...
credit_card_payment_prep as (
    ...
    select
        ...
        row_number() over (partition by credit_card_payments.credit_card_payment_id {{ fivetran_utils.partition_by_source_relation(package_name='quickbooks', alias='credit_card_payments') }}
