...
final as (
    ...
    left join refund_receipt_lines refund_receipt_lines_relation
        on refund_receipts.source_relation = refund_receipt_lines_relation.source_relation

    left join items
        on refund_receipt_lines.sales_item_item_id = items.item_id
        and refund_receipt_lines_relation.source_relation = items.source_relation
)
