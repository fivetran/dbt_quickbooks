...
final as (
    ...
    select
        ...
        deposit_lines.amount * (coalesce(deposits.exchange_rate, deposits.home_total_amount/nullif(deposits.total_amount, 0), 1)) as converted_amount,
        deposits.total_amount,
        deposits.total_amount * (coalesce(deposits.exchange_rate, deposits.home_total_amount/nullif(deposits.total_amount, 0), 1)) as total_converted_amount
    from deposits
