...
balance_sheet_account_class as (

    select * 
    from {{ var('balance_sheet_account_class') }}
),
...
final as (
    ...
    left join balance_sheet_account_class
        on general_ledger_by_period.account_class = balance_sheet_account_class.account_class
)
