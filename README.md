...
vars:
    find . -name .DS_Store -print0 | xargs -0 git rm -f --ignore-unmatchr['quickbooks_usa','quickbooks_canada'] # use this if the data is in different schemas/datasets of the same database/project
